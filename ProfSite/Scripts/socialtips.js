...
(function ($) {
    ...
    $.extend(SocialTips.prototype, {
        init: function (options, control) {
            var self = this;
            this.widget = control;
            this.widgetSortBy = self.widget.find("div.social-tips-sortby");
            this.widgetFilterBy = self.widget.find("ul.social-tips-filterby");
            this.widgetList = self.widget.find("ul.syndicatedcontent-socialtips");
        ...
        _bindFilter: function () {
            ...
            self.widgetFilterBy.find("li > a").click(function (event) {
                ...
                self.widget.find("#pageSocialTips").show();
        ...
        _bindPaging: function () {
            ...
            var nextPage = self.widget.find("#pageSocialTips");
        ...
        _getTopics: function (paging, self) {
            ...
            var cloneLoading = self.widgetList.find(".socialTipsLoading").clone();
            if (paging === null) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var paging = response.find("#pageSocialTips");
    ...
    $.fn.socialTips = function (options) {
        var control = new SocialTips();
