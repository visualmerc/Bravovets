<%@ Page Title="Retrieve Password" Language="C#" AutoEventWireup="true" ValidateRequest="false" %>
                                ...
                                <form id="LFW20form" class="universalForm" runat="server">
                                    ...
                                    <asp:Panel ID="LFW20Container" runat="server">
                                        <fieldset>
                                            ...
                                            <asp:Literal ID="litRequestPasswordMessage" runat="server"></asp:Literal>
                                            <asp:Literal runat="server" ID="litRequestPasswordForm"></asp:Literal>
                                        </fieldset>
                                        <dl class="formCols" id="fsubmit">
                                            <dt><span class="displayNone"></span></dt>
                                            <dd>
                                                <asp:Button runat="server" ID="butRequest" />
                                            </dd>
                                        </dl>
                                    </asp:Panel>
