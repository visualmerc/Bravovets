<%@ Page Title="Change Email" Language="C#" AutoEventWireup="true" ValidateRequest="false" %>
                    ...
                    <div class="col-sm-6 col-sm-offset-3">
                        <div class="white-trans-bg">
                            <div class="lfwbrav_content">
                                <form id="LFW20form" runat="server">
                                    <!-- This part of the page contains LFW20 controls. Do not remove! -->
                                    <asp:Panel ID="LFW20Container" runat="server">
                                        <fieldset>
                                            <legend><%=Resource.BravoVets_Footer_ChangeEmail %></legend>
                                            <asp:Literal runat="server" ID="litChangeEmailAddressForm"></asp:Literal>
                                        </fieldset>
